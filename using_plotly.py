...
def vague_seuil_px_opti2():
    ...
    fig.add_trace(go.Scatter(x=x_courbe, y=data['courbe_sains'], marker=dict(color='#636EFA',size=1), marker_line=dict(width=2),showlegend=False, name="sains",yaxis="y", ), 2, 1)
