...
Lien utile pour comprendre le [Modèle SIR](https://interstices.info/modeliser-la-propagation-dune-epidemie/) . <br/>

[Thèse](https://tel.archives-ouvertes.fr/tel-00841444/file/BicharaPhDThesis.pdf) sur l'étude de modèles épidémiologiques: Stabilité, observation et estimation de paramètres.
